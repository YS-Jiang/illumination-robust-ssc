...
class OccHead(nn.Module):
    def __init__(
        ...
        # Lovász-Softmax loss (directly optimizes the per-class IoU/mIoU; 0 = off for backward compat).
        self.loss_voxel_lovasz_weight = self.loss_weight_cfg.get('loss_voxel_lovasz_weight', 0.0)
    ...
    def loss(self, output_voxels, target_voxels):
        ...
        if self.loss_voxel_lovasz_weight > 0:
            from mmdet3d_plugin.utils.lovasz_softmax import lovasz_softmax
